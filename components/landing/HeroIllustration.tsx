  ...
  return (
    <div className="relative mx-auto w-full max-w-md">
      ...
      <svg
        ...
        aria-hidden="true"
      >
        {/* Left: cluster of photo thumbnails (sky-blue accents) — each floats at a different speed */}
        <g transform="translate(20 50)">
          <g className="float-slow" style={{ transformOrigin: "60px 40px" }}>
          ...
          <g className="float-medium" style={{ transformOrigin: "105px 150px" }}>
          ...
          <g className="float-fast" style={{ transformOrigin: "50px 190px" }}>
        ...
        {/* Centre arrow with sliding animation */}
        <g transform="translate(195 140)" className="arrow-anim">
        ...
        {/* Right: PDF (emerald) — gently floats */}
        <g transform="translate(310 35)" className="float-medium" style={{ transformOrigin: "75px 100px" }}>
      ...
      {/* AI badge — amber pulse, sits above the arrow */}
